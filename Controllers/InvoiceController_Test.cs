...
//                string IsProduction = "0";//ConfigurationSettings.AppSettings["IsProduction"].ToString();

//                string SlikaUrlAsraiValidate = "https://demo.ezcount.co.il/api/payment/validate/";
//                string SuccessUrlAshrai = "http://giddyup.co.il/close.html";
//                string SlikaUrlAshrai = "https://demo.ezcount.co.il/api/payment/prepareSafeUrl/clearingFormForMerchant";

//                string SuccessUrlToken = "https://www.giddyup.co.il";
//                string SlikaUrlToken = "https://demo.ezcount.co.il/api/payment/prepareSafeUrl/token";
//                string SlikaUrlChargeToken = "https://demo.ezcount.co.il/api/payment/chargeToken";
