    ...
    public class InvoiceController : ApiController
    {
        ...
        public IHttpActionResult sendInvoice(dynamic Params)
        {
            ...
            try
            {
                ...
                if (IsProduction == "1") MasterApiKey = ConfigurationSettings.AppSettings["MasterApiKey"].ToString();
                            ...
                            using (var Context = new Context())
                            {
                                ...
                                if (item != null)
                                {
                                    ...
                                    if (doc_type == "Mas" || doc_type == "MasKabala")
                                    {
                                        ...
                                        responseZikuy = GetEzcountRes(Params, listProduct, Payment, DocType, IsProduction, doc, ref lg, p,MasterApiKey);
                                    }
        ...
        private dynamic GetEzcountRes(dynamic Params, List<dynamic> listProduct, List<dynamic> Payment, int DocType, string IsProduction, DocCreation doc, ref Logs lg, decimal p,string MasterApiKey)
        {

            var reqObjZikuy = new
            {
                api_key = (string)Params.api_key,
                created_by_api_key = MasterApiKey,// "aca36103e816eae2b9986b952f92881b309c3b6290813ebd1469fd350cd48746",
                api_email = (string)Params.api_email,
                ua_uuid = (string)Params.ua_uuid,
