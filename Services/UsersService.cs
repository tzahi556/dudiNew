    ...
    public class UsersService
    {
        ...
        public static List<User> GetUsers(string Role, bool IncludeDeleted = false)
        {
            using (var Context = new Context())
            {
                ...
                SqlParameter CurrentUserRolePara = new SqlParameter("CurrentUserRole", CurrentUser.Role);
                SqlParameter SearchRolePara = new SqlParameter("SearchRole", Role);
                SqlParameter IncludeDeletedPara = new SqlParameter("IncludeDeleted", IncludeDeleted);
                SqlParameter CurrentUserIdPara = new SqlParameter("CurrentUserId", CurrentUser.Id);

                try
                {
                    var query = Context.Database.SqlQuery<User>
                    ("GetUsersNew @Farm_Id,@CurrentUserRole,@SearchRole,@IncludeDeleted,@CurrentUserId",
                    Farm_IdPara, CurrentUserRolePara, SearchRolePara, IncludeDeletedPara, CurrentUserIdPara);
